...
This file provides guidance to Codex (Codex.ai/code) when working with code in this repository. It serves as the single source of truth for the project's state, architecture, and backlog.
